      ...
      <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-3xl mx-auto">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 mb-8">
            ...
            <span className="text-sm text-white/80 font-medium">2026 Seoul</span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8 text-white/70 mb-12">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-medium">2026.03.25 (Wed) – 03.29 (Sun)</span>
            </div>
            <div className="flex items-center gap-2">
              <svg className="w-5 h-5 text-brand-primary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 hover:shadow-sm transition-shadow">
              ...
              <h3 className="text-sm font-semibold text-neutral-950 mb-1">Date</h3>
              <p className="text-sm text-neutral-500">2026.03.25 (Wed) – 03.29 (Sun)</p>
              <p className="text-xs text-neutral-400 mt-1">10:00 – 18:00 (Last day until 17:00)</p>
            </div>
            ...
            <div className="card p-6 hover:shadow-sm transition-shadow">
              ...
              <h3 className="text-sm font-semibold text-neutral-950 mb-1">Venue</h3>
              <p className="text-sm text-neutral-500">COEX Hall A, B</p>
              <p className="text-xs text-neutral-400 mt-1">513 Yeongdong-daero, Gangnam-gu, Seoul</p>
            </div>
            ...
            <div className="card p-6 hover:shadow-sm transition-shadow">
              ...
              <h3 className="text-sm font-semibold text-neutral-950 mb-1">Scale</h3>
              <p className="text-sm text-neutral-500">450+ Exhibitors / 120,000+ Visitors</p>
              <p className="text-xs text-neutral-400 mt-1">Korea&apos;s largest living design fair</p>
            </div>
          </div>
        </div>
      </section>
